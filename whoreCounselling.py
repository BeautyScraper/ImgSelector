...
# imgHeight = height/2
# imgWidth = width/4
inDirPath = r'C:\Heaven\Haven\brothel\cousin ne Bhikhari se chudwaya'
        ...
        with open(outTxtPath, "a+") as txtfile:
            ...
            for r in range(atATime):
                ...
                if r == 0:
                    ...
                    root.bind('<j>', lambda e, index=inDirPath + dirlist[i]: RclickOnButton(e, index))
                if r == 1:
                    ...
                    root.bind('<l>', lambda e, index=inDirPath + dirlist[i]: RclickOnButton(e, index))
